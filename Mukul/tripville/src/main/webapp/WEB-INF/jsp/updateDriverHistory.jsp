...
<title>Tripville - Update Driver History</title>
</head>
<body>
					...
					<div class="col-lg-6" style="width:75%">
						<form:form id="myForm" method="post"
							...
							<fieldset>
								...
								<div class="form-group">
									<label for="ratingInput" class="col-lg-3 control-label">Rating</label>
									<div class="col-lg-9">
										<form:input type="text" class="form-control" path="rating"	id="ratingInput" placeholder="Rating" />
										<form:errors path="rating" cssClass="error" />
									</div>
								</div>

								<div class="form-group">
									<label for="drivercommentsInput" class="col-lg-3 control-label">Comments</label>
									<div class="col-lg-9">
										<form:input type="text" class="form-control" path="comments"	id="drivercommentsInput" placeholder="Comments" />
